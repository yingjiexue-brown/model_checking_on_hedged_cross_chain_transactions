...
S_B_R:\* clock =8,Bob redeems
    ...
    if ~(asset_contract["BOB"].state= REDEEMED)/\step_taken[B_R] then
...
\* BEGIN TRANSLATION - the hash of the PCal code: PCal-eee9c7eb9b60858957579393b9ce0d58
...
S_B_R == /\ pc[BITCOIN] = "S_B_R"
         ...
         /\ IF ~(asset_contract'["BOB"].state= REDEEMED)/\step_taken'[B_R]
...
\* END TRANSLATION - the hash of the generated TLA code (remove to silence divergence warnings): TLA-dd3383633f42a7944cca4f05aef83905
====
