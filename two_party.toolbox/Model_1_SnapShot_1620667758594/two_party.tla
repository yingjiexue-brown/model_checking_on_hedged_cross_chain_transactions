...
fair process bitcoin = BITCOIN begin 
    ...
    if  step_taken[SAS1]/\step_taken[SAS3]/\clock<=asset_contract["ALICE"].timeout/\ asset_contract["ALICE"].state= ESCROW then \* note that we do not require as3 to finish to finish as4
...
\* BEGIN TRANSLATION - the hash of the PCal code: PCal-c4c38185568a67dd967ee13e27e52b5e
...
\* END TRANSLATION - the hash of the generated TLA code (remove to silence divergence warnings): TLA-9365681e29fb7a915df9a0f83d828096
